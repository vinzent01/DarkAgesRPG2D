...
public class CharacterCreationMenu : Widget {
        ...
        var okButton = new ButtonText("Ok", () => {
            ...
            if (raceObject != null){
                ...
                if (raceComponent != null){
                    Character.Offset = new Vector2(0, -(raceComponent.currentSprite.Height / 2));
                    Character.flipOffset = new Vector2(0, -(raceComponent.currentSprite.Height / 2));
                }
            ...
            Globals.world.Add(Character);
            Globals.Camera.target = Character;
            

            Globals.RootWidget.RemoveById("Character-Creation-Menu");
        });
    ...
    void SetAvailableHairs(string raceId, int genre){
        var HairsAssets = Globals.packageManager.GetAssetByTags("hair");

        HairsAssets.Sort((a, b) => {
            if (a.id.ToLower().Contains(raceId)) return -1;
            if (b.id.ToLower().Contains(raceId)) return 1;
    ...
    void SetAvailableBeards(string raceId){
        var BeardsAssets = Globals.packageManager.GetAssetByTags("beard");
    ...
    public void PrepareData(){
        ...
        var racesAssets = Globals.packageManager.GetAssetByTags("race");
    ...
    public Object CreateBaseCharacter(){
        return new Object(
            "player", 
            "player",
            new EquipmentList(),
